                            ...
                            <div className="flex flex-col border border-gray-500 border-l-0 border-b-0">
                                {
                                    variants && (
                                        <div className="flex flex-col">
                                            <img className="max-w-md" src={`data:image/png;base64,${variants[0]}`} alt='Model Generated Image' />
                        ...
                        <div className="px-10 h-full flex flex-col items-center justify-around">
                            {
                                variants && (
                                    <>
                                        <img className="w-40" src={`data:image/png;base64,${variants[1]}`} alt='Model Generated Image' />
                                        <img className="w-40" src={`data:image/png;base64,${variants[2]}`} alt='Model Generated Image' />
                                        <img className="w-40" src={`data:image/png;base64,${variants[3]}`} alt='Model Generated Image' />
                                    </>
                                )
                            }
